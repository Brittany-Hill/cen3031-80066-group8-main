...
import com.mygdx.game.LogSystem;
...
public class CharacterTest {
	...
	@Test
	public void TestInventoryOfCharacter1()
	{
		//Arrange
		Character sut = new Character(1);
        Card answer = new Card(1, "Attack", "Attacks", false, 10, 0);
	...
	@Test
	public void TestCharacterSetMethods()
    {
        //Arrange
		Character sut = new Character(1);
